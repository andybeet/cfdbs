...
#'
#'   \code{species} containing the result of the executed \code{$sql} statement
#'
...
get_species <- function(channel,species="all"){
  ...
  sqlStatement <- create_sql_cfdbs(species,fieldName="nespp3",dataType="%03d",defaultSqlStatement="select * from cfdbs.cfspp")
